...
methods melora calls in it's lifecycle.
...
For this specific endpoint, you may need `WebView` or `Forms` to get user inputs. The [`hetu_melora_plugin`][hetu_melora_plugin] provides
such APIs.

> Learn more about it in the [melora Plugin API][melora_plugin_api] section

### The `.authStateStream` property

The `AuthEndpoint.authStateStream` property is also necessary to notify melora about the authentication status. [`hetu_std`][hetu_std] is a built-in
...
Following events are respected by melora:
...
methods melora calls in its lifecycle.
...
| ------------------- | ------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| `me()`              | Fetches the current user's information.                                  | [`meloraUserObject`][meloraUserObject]                                                                                         |
| `savedTracks()`     | Fetches the user's saved tracks with pagination support.                 | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullTrackObject`][meloraFullTrackObject]       |
| `savedPlaylists()`  | Fetches the user's saved playlists with pagination support.              | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullPlaylistObject`][meloraFullPlaylistObject] |
| `savedAlbums()`     | Fetches the user's saved albums with pagination support.                 | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullAlbumObject`][meloraFullAlbumObject]       |
| `savedArtists()`    | Fetches the user's saved artists with pagination support.                | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullArtistObject`][meloraFullArtistObject]     |
...
| Method       | Description                                                                          | Returns                                                  |
| ------------ | ------------------------------------------------------------------------------------ | -------------------------------------------------------- |
| `getTrack()` | Fetches track information by ID.                                                     | [meloraFullTrackObject][meloraFullTrackObject]         |
...
| `radio()`    | Fetches related tracks based on specified tracks. Try to return a List of 50 tracks. | [List\<meloraFullTrackObject\>][meloraFullTrackObject] |
...
| Method       | Description                                                                              | Returns                                                                                                                    |
| ------------ | ---------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `getAlbum()` | Fetches album information by ID.                                                         | [`meloraFullAlbumObject`][meloraFullAlbumObject]                                                                         |
| `tracks()`   | Fetches tracks of the specified album. Accepts an ID and optional pagination parameters. | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullTrackObject`][meloraFullTrackObject] |
| `releases()` | Fetches new album releases user followed artists or globally                             | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullAlbumObject`][meloraFullAlbumObject] |
...
| Method        | Description                                                                            | Returns                                                                                                                      |
| ------------- | -------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------- |
| `getArtist()` | Fetches artist information by ID.                                                      | [`meloraFullArtistObject`][meloraFullArtistObject]                                                                         |
| `related()`   | Fetches related artists based on the specified artist ID. Accepts optional pagination. | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullArtistObject`][meloraFullArtistObject] |
| `topTracks()` | Fetches top tracks of the specified artist. Accepts optional pagination.               | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullTrackObject`][meloraFullTrackObject]   |
| `albums()`    | Fetches albums of the specified artist. Accepts optional pagination.                   | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullAlbumObject`][meloraFullAlbumObject]   |
...
| Method           | Description                                 | Returns                                                                                                                    |
| ---------------- | ------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| `getPlaylist`    | Fetches a playlist by its ID.               | [`meloraFullPlaylistObject`][meloraFullPlaylistObject]                                                                   |
| `tracks`         | Fetches tracks in a playlist.               | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullTrackObject`][meloraFullTrackObject] |
| `create`         | Creates a new playlist and returns          | [`meloraFullPlaylistObject`][meloraFullPlaylistObject]                                                                   |
...
| `all()`       | Searches for all types of content.  | [`meloraSearchResponseObject`][meloraSearchResponseObject]                                                                     |
| `albums()`    | Searches only for albums.           | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullAlbumObject`][meloraFullAlbumObject]       |
| `artists()`   | Searches only for artists.          | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullArtistObject`][meloraFullArtistObject]     |
| `tracks()`    | Searches only for tracks.           | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullTrackObject`][meloraFullTrackObject]       |
| `playlists()` | Searches only for playlists.        | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraFullPlaylistObject`][meloraFullPlaylistObject] |
...
| Method           | Description                              | Returns                                                                                                                                        |
| ---------------- | ---------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------- |
| `sections()`     | Returns the sections of the home page.   | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of [`meloraBrowseSectionObject`][meloraBrowseSectionObject] of `Object` |
| `sectionItems()` | Returns the items of a specific section. | [`meloraPaginationResponseObject`][meloraPaginationResponseObject] of `Object`                                                               |
...
[melora_plugin_api]: /docs/plugin-apis
[meloraUserObject]: /docs/reference/models#user
[meloraPaginationResponseObject]: /docs/reference/models#pagination-response
...
[meloraSearchResponseObject]: /docs/reference/models#search-response
[meloraBrowseSectionObject]: /docs/reference/models#browse-section
