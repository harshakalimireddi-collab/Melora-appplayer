...
title: Introduction
description: Learn how to develop plugins for melora
order: 0
---

Plugins in melora are used for fetching metadata (Playlist, Album, Artist, Track Info, Search etc) and scrobbling. It gives developers
access to melora's internal APIs to create custom metadata providers and audio [scrobblers][scrobbler_wiki].
...
To develop plugins for melora, you need to have the following requirements:

- Basic programming knowledge
- [Dart][dart] and [Flutter][flutter] knowledge
- [Visual Studio Code][vscode] or any other code editor

melora uses [hetu_script][hetu_script_link]. It's kind of similar to Typescript.
...
However, we created some helpful libraries to aid with melora plugin development. The [hetu-community][hetu_community] is a
...
- [**KRTirtho/hetu_melora_plugin**][hetu_melora_plugin]: A library for melora plugin development. It provides access to melora's internal APIs
