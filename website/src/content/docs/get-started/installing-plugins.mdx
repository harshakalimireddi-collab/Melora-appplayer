...
description: Learn how to install and manage plugins in melora
order: 1
---

Let's first learn how to install plugins in melora. It's pretty simple.
...
Usually, melora will list public repositories of plugins from github and codeberg in the _Available plugins_ section.
