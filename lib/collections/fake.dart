...
import 'package:melora/provider/history/summary.dart';

abstract class FakeData {
  static final MeloraImageObject image = MeloraImageObject(
    height: 100,
    width: 100,
    url: "https://dummyimage.com/100x100/cfcfcf/cfcfcf.jpg",
  );

  static final MeloraFullArtistObject artist = MeloraFullArtistObject(
    id: "1",
    name: "What an artist",
  ...
  static final MeloraFullAlbumObject album = MeloraFullAlbumObject(
    id: "1",
    name: "A good album",
    externalUri: "https://example.com",
  ...
  static final MeloraSimpleArtistObject artistSimple =
  ...
  static final MeloraSimpleAlbumObject albumSimple = MeloraSimpleAlbumObject(
    albumType: MeloraAlbumType.album,
    artists: [],
    externalUri: "https://example.com",
    id: "1",
  ...
  static final MeloraFullTrackObject track = MeloraTrackObject.full(
    id: "1",
    name: "A good track",
    externalUri: "https://example.com",
    album: albumSimple,
  ...
  static final MeloraUserObject user = MeloraUserObject(
    id: "1",
    name: "User Name",
    externalUri: "https://example.com",
    images: [image],
  ...
  static final MeloraFullPlaylistObject playlist = MeloraFullPlaylistObject(
      id: "1",
  ...
  static final MeloraSimplePlaylistObject playlistSimple =
  ...
  static final MeloraBrowseSectionObject browseSection =
      MeloraBrowseSectionObject(
          id: "section-id",
