...
class MetadataPluginSavedPlaylistsNotifier
    extends PaginatedAsyncNotifier<MeloraSimplePlaylistObject> {
  ...
  void updatePlaylist(MeloraSimplePlaylistObject playlist) {
  ...
  Future<void> addFavorite(MeloraSimplePlaylistObject playlist) async {
    if (state.value == null) return;
  ...
  Future<void> removeFavorite(MeloraSimplePlaylistObject playlist) async {
    if (state.value == null) return;
