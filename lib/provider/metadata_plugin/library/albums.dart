...
class MetadataPluginSavedAlbumNotifier
    extends PaginatedAsyncNotifier<MeloraSimpleAlbumObject> {
  @override
  ...
  Future<void> addFavorite(List<MeloraSimpleAlbumObject> albums) async {
  ...
  Future<void> removeFavorite(List<MeloraSimpleAlbumObject> albums) async {
    if (albums.isEmpty || state.value == null) return;
