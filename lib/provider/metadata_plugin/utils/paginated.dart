...
mixin PaginatedAsyncNotifierMixin<K>
    ...
    on AsyncNotifierBase<MeloraPaginationResponseObject<K>> {
  Future<MeloraPaginationResponseObject<K>> fetch(int offset, int limit);
...
abstract class PaginatedAsyncNotifier<K>
    extends AsyncNotifier<MeloraPaginationResponseObject<K>>
    with PaginatedAsyncNotifierMixin<K>, MetadataPluginMixin<K> {}

abstract class AutoDisposePaginatedAsyncNotifier<K>
    extends AutoDisposeAsyncNotifier<MeloraPaginationResponseObject<K>>
    with PaginatedAsyncNotifierMixin<K>, MetadataPluginMixin<K> {}
