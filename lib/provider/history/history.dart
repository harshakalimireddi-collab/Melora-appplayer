...
class PlaybackHistoryActions {
  ...
  Future<void> addPlaylists(List<MeloraSimplePlaylistObject> playlists) async {
  ...
  Future<void> addAlbums(List<MeloraSimpleAlbumObject> albums) async {
    await _batchInsertHistoryEntries([
  ...
  Future<void> addTracks(List<MeloraTrackObject> tracks) async {
    assert(
