...
typedef PlaybackHistoryTrack = ({int count, MeloraTrackObject track});
typedef PlaybackHistoryArtist = ({int count, MeloraSimpleArtistObject artist});
...
class HistoryTopTracksNotifier extends FamilyPaginatedAsyncNotifier<
  ...
  fetch(offset, limit) async {
    ...
    return MeloraPaginationResponseObject<PlaybackHistoryTrack>(
      items: items,
  ...
  List<PlaybackHistoryArtist> getArtistsWithCount(
    Iterable<MeloraSimpleArtistObject> artists,
  ) {
...
final historyTopTracksProvider = AsyncNotifierProviderFamily<
    ...
    MeloraPaginationResponseObject<PlaybackHistoryTrack>,
    HistoryDuration>(
  () => HistoryTopTracksNotifier(),
);
