...
import 'package:melora/components/form/checkbox_form_field.dart';
      ...
      try {
        ...
        if (context.mounted &&
            !ref
                ...
                .hasError) {
          context.router.maybePop<MeloraFullPlaylistObject>(
            await ref
                  ...
                  return Column(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          Button.secondary(
                            leading: const Icon(MeloraIcons.edit),
                            child: Text(
                          ...
                          IconButton.destructive(
                            icon: const Icon(MeloraIcons.trash),
...
class PlaylistCreateDialogButton extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, ref) {
    return Button.secondary(
      leading: const Icon(MeloraIcons.addFilled),
