...
import 'package:melora/components/markdown/markdown.dart';
import 'package:melora/extensions/constrains.dart';
import 'package:melora/extensions/context.dart';
import 'package:melora/models/metadata/metadata.dart';
import 'package:melora/modules/metadata_plugins/plugin_update_available_dialog.dart';
import 'package:melora/provider/metadata_plugin/core/auth.dart';
import 'package:melora/provider/metadata_plugin/core/support.dart';
...
final validAbilities = {
  PluginAbilities.metadata: ("Metadata", MeloraIcons.album),
  PluginAbilities.audioSource: ("Audio Source", MeloraIcons.music),
};
              ...
              return Basic(
                leading: snapshot.hasData
                    ...
                    : Container(
                        ...
                        child: const Icon(MeloraIcons.plugin),
                      ),
                    ...
                    if (repoUrl != null)
                      Wrap(
                        ...
                        children: [
                          if (isOfficial)
                            PrimaryBadge(
                              leading: const Icon(MeloraIcons.done),
                            ...
                            Container(
                              ...
                              child: Row(
                                ...
                                spacing: 4,
                                children: [
                                  const Icon(MeloraIcons.warning, size: 14),
                                  Text(
                ...
                children: [
                  if (requiresAuth && !isAuthenticated)
                    Row(
                      spacing: 8,
                      children: [
                        const Icon(MeloraIcons.warning, color: Colors.yellow),
                  ...
                  if (hasUpdate)
                    SizedBox(
                      ...
                      child: Basic(
                        leading: const Icon(MeloraIcons.update),
                ...
                children: [
                  if (isDefaultMetadata || isDefaultAudioSource)
                    Consumer(builder: (context, ref, _) {
                      ...
                      return Button(
                        ...
                        leading: const Icon(MeloraIcons.heartFilled),
                  ...
                  if ((isDefaultMetadata || isDefaultAudioSource) &&
                    ...
                    Button.primary(
                      ...
                      leading: const Icon(MeloraIcons.login),
                    ...
                    Button.destructive(
                      ...
                      leading: const Icon(MeloraIcons.logout),
