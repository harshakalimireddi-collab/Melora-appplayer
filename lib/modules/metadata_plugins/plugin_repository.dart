...
final validTopics = {
  "melora-metadata-plugin": ("Metadata", MeloraIcons.album),
  "melora-audio-source-plugin": ("Audio Source", MeloraIcons.music),
};
    ...
    return Card(
      child: Column(
        ...
        children: [
          Basic(
            title: Text(
              pluginRepo.name.startsWith("melora-plugin")
                  ? pluginRepo.name
                      .replaceFirst("melora-plugin-", "")
                      .trim()
                      .toCapitalCase()
