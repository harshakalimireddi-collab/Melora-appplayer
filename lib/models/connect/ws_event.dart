...
class WebSocketAddTrackEvent extends WebSocketEvent<MeloraFullTrackObject> {
  WebSocketAddTrackEvent(MeloraFullTrackObject data)
      : super(WsEvent.addTrack, data);

  WebSocketAddTrackEvent.fromJson(Map<String, dynamic> json)
      : super(
          WsEvent.addTrack,
          MeloraFullTrackObject.fromJson(
