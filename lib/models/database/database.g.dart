...
class $PreferencesTableTable extends PreferencesTable
  ...
  @override
  late final GeneratedColumnWithTypeConverter<MeloraColor, String>
  ...
  static TypeConverter<MeloraColor, String> $converteraccentColorScheme =
...
class PreferencesTableData extends DataClass
  ...
  final MeloraColor accentColorScheme;
  ...
  factory PreferencesTableData.fromJson(Map<String, dynamic> json,
    ...
    return PreferencesTableData(
      ...
      accentColorScheme:
          serializer.fromJson<MeloraColor>(json['accentColorScheme']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'accentColorScheme': serializer.toJson<MeloraColor>(accentColorScheme),
...
class PreferencesTableCompanion extends UpdateCompanion<PreferencesTableData> {
  ...
  final Value<MeloraColor> accentColorScheme;
  ...
  PreferencesTableCompanion copyWith(
      ...
      Value<MeloraColor>? accentColorScheme,
...
class $AudioPlayerStateTableTable extends AudioPlayerStateTable
  ...
  @override
  late final GeneratedColumnWithTypeConverter<List<MeloraTrackObject>, String>
      tracks = GeneratedColumn<String>('tracks', aliasedName, false,
              type: DriftSqlType.string,
              requiredDuringInsert: false,
              defaultValue: const Constant("[]"))
          .withConverter<List<MeloraTrackObject>>(
  ...
  static TypeConverter<List<String>, String> $convertercollections =
      const StringListConverter();
  static TypeConverter<List<MeloraTrackObject>, String> $convertertracks =
...
class AudioPlayerStateTableData extends DataClass
  ...
  final List<MeloraTrackObject> tracks;
  ...
  factory AudioPlayerStateTableData.fromJson(Map<String, dynamic> json,
    ...
    return AudioPlayerStateTableData(
      ...
      tracks: serializer.fromJson<List<MeloraTrackObject>>(json['tracks']),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'tracks': serializer.toJson<List<MeloraTrackObject>>(tracks),
...
class AudioPlayerStateTableCompanion
  ...
  final Value<List<MeloraTrackObject>> tracks;
  ...
  AudioPlayerStateTableCompanion copyWith(
      ...
      Value<List<MeloraTrackObject>>? tracks,
...
class $$PreferencesTableTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<MeloraColor, MeloraColor, String>
...
class $$PreferencesTableTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<MeloraColor, String>
      get accentColorScheme => $composableBuilder(
  ...
  $$PreferencesTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<MeloraColor> accentColorScheme = const Value.absent(),
...
class $$AudioPlayerStateTableTableFilterComposer
  ...
  ColumnWithTypeConverterFilters<List<MeloraTrackObject>,
          List<MeloraTrackObject>, String>
...
class $$AudioPlayerStateTableTableAnnotationComposer
  ...
  GeneratedColumnWithTypeConverter<List<MeloraTrackObject>, String>
      get tracks => $composableBuilder(
  ...
  $$AudioPlayerStateTableTableTableManager(
      ...
      : super(TableManagerState(
          ...
          updateCompanionCallback: ({
            ...
            Value<List<MeloraTrackObject>> tracks = const Value.absent(),
