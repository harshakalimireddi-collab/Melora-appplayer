...
class AppLocalizationsVi extends AppLocalizations {
  ...
  @override
  String get u_love_Melora => 'Chúng tôi biết bạn yêu Melora';

  @override
  String get check_for_updates => 'Kiểm tra cập nhật';

  @override
  String get about_Melora => 'Về Melora';
  ...
  String get spotube_description =>
      'Melora, một ứng dụng Spotify nhẹ, đa nền tảng và miễn phí';
  ...
  String get download_ip_ban_warning =>
      'Địa chỉ IP của bạn có thể bị chặn trên YouTube do yêu cầu tải xuống quá mức so với bình thường. Chặn IP có nghĩa là bạn không thể sử dụng YouTube (ngay cả khi bạn đã đăng nhập) ít nhất 2-3 tháng từ thiết bị IP đó. Và Melora không chịu trách nhiệm nếu điều này xảy ra';
  ...
  String get download_agreement_3 =>
      'Tôi hoàn toàn nhận thức được rằng địa chỉ IP của tôi có thể bị chặn trên YouTube và tôi không đổ lỗi cho Melora hoặc chủ sở hữu/người đóng góp của nó về bất kỳ tai nạn nào do hành động này của tôi';
  ...
  String get encryption_failed_warning =>
      'Melora không thành công trong việc mã hóa nhằm lưu trữ dữ liêu an toàn. vậy nên sẽ chuyển về lưu trữ không an toàn\nNếu bạn đang sử dụng Linux, đảm bảo rằng bạn có sử dụng dịch vụ bảo mật (gnome-keyring, kde-wallet, keepassxc, v.v.)';
  ...
  String get choose_your_region_description =>
      'Điều này sẽ giúp Melora hiển thị nội dung phù hợp cho vị trí của bạn.';
  ...
  String get help_project_grow_description =>
      'Melora là một dự án mã nguồn mở. Bạn có thể giúp dự án này phát triển bằng cách đóng góp vào dự án, báo cáo lỗi hoặc đề xuất tính năng mới.';
  ...
  String get enable_connect_description =>
      'Điều khiển Melora từ các thiết bị khác';
  ...
  @override
  String get spotube_has_an_update => 'Melora có bản cập nhật';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Melora Nightly $nightlyBuildNum đã được phát hành';
  }

  @override
  String release_version(Object version) {
    return 'Melora v$version đã được phát hành';
  }
