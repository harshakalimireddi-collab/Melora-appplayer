...
class AppLocalizationsZh extends AppLocalizations {
  ...
  @override
  String get u_love_Melora => '我们明白你喜欢 Melora';

  @override
  String get check_for_updates => '检查更新';

  @override
  String get about_Melora => '关于 Melora';
  ...
  String get download_ip_ban_warning =>
      '小心，如果出现超出正常的下载请求那你的 IP 可能会被 YouTube 封禁，这意味着你的设备将在长达 2-3 个月的时间内无法使用该 IP 访问 YouTube（即使你没登录）。Melora 对此不承担任何责任';
  ...
  String get download_agreement_3 =>
      '我完全了解我的 IP 存在被 YouTube的风险。我同意 Melora 的所有者与贡献者们无须对我目前的行为所导致的任何后果负责';
  ...
  @override
  String get choose_your_region_description => '这将帮助Melora为您的位置显示正确的内容。';
  ...
  String get help_project_grow_description =>
      'Melora是一个开源项目。您可以通过为项目做出贡献、报告错误或建议新功能来帮助该项目成长。';
  ...
  @override
  String get enable_connect_description => '从其他设备控制Melora';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Melora Nightly $nightlyBuildNum 已发布';
  }

  @override
  String release_version(Object version) {
    return 'Melora v$version 已发布';
  }
...
class AppLocalizationsZhTw extends AppLocalizationsZh {
  ...
  @override
  String get u_love_Melora => '我們明白你喜歡 Melora';

  @override
  String get check_for_updates => '檢查更新';

  @override
  String get about_Melora => '關於 Melora';
  ...
  @override
  String get download_ip_ban_warning =>
      '小心，如果出現超出正常的下載請求，那你的 IP 可能會被 YouTube 封鎖，這意味著你的裝置將在長達 2-3 個月的時間內無法使用該 IP 訪問 YouTube（即使你沒登入）。Melora 不會因而承擔任何責任';
  ...
  @override
  String get download_agreement_3 =>
      '我完全了解我的 IP 存在被 YouTube 封鎖的風險。並且我明白 Melora 的擁有者與貢獻者們無須對我目前的行為所導致的任何後果負責';
  ...
  @override
  String get choose_your_region_description => '這能幫助 Melora 為您的所在位置顯示正確的內容。';
  ...
  @override
  String get help_project_grow_description =>
      'Melora是一個開源專案。您可以透過為專案做出貢獻、回報錯誤或建議新功能來幫助專案成長。';
  ...
  @override
  String get enable_connect_description => '從其他裝置控制Melora';
  ...
  @override
  String nightly_version(Object nightlyBuildNum) {
    return 'Melora Nightly $nightlyBuildNum 已發佈';
  }

  @override
  String release_version(Object version) {
    return 'Melora v$version 已發布';
  }
