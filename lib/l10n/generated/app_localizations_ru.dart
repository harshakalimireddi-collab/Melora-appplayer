...
class AppLocalizationsRu extends AppLocalizations {
  ...
  @override
  String get u_love_Melora => 'Мы знаем что вам нравится Melora';

  @override
  String get check_for_updates => 'Проверьте наличие обновлений';

  @override
  String get about_Melora => 'О Melora';
  ...
  String get spotube_description =>
      'Melora – это легкий, кросс-платформенный клиент Spotify, предоставляющий бесплатный доступ для всех пользователей';
  ...
  String get download_agreement_3 =>
      'Я полностью осознаю, что мой IP-адрес может быть заблокирован на YouTube, и я не считаю Melora или его владельцев/соавторов ответственными за какие-либо неприятности, вызванные моими текущими действиями';
  ...
  String get encryption_failed_warning =>
      'Melora использует шифрование для безопасного хранения ваших данных. Однако в этом случае произошла ошибка. Поэтому будет использовано небезопасное хранилище.\nЕсли вы используете Linux, убедитесь, что у вас установлен какой-либо инструмент для работы с секретами (gnome-keyring, kde-wallet, keepassxc и т.д.)';
  ...
  String get choose_your_region_description =>
      'Это поможет Melora показать вам правильный контент\nдля вашего местоположения.';
  ...
  String get help_project_grow_description =>
      'Melora - это проект с открытым исходным кодом. Вы можете помочь этому проекту развиваться, внося вклад в проект, сообщая ошибках или предлагая новые функции.';
  ...
  String get enable_connect_description =>
      'Управление Melora с других устройств';
  ...
  @override
  String get spotube_has_an_update => 'В Melora доступно обновление';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Melora Nightly $nightlyBuildNum выпущен';
  }

  @override
  String release_version(Object version) {
    return 'Melora v$version выпущен';
  }
