...
class AppLocalizationsCs extends AppLocalizations {
  ...
  @override
  String get u_love_Melora => 'Víme, že milujete Melora';
  ...
  String get download_ip_ban_warning =>
      'Mimochodem, vaše IP může být na YouTube zablokována kvůli nadměrným požadavkům na stahování. Blokování IP znamená, že nemůžete používat YouTube (i když jste přihlášeni) alespoň 2-3 měsíce ze zařízení s touto IP. A Melora nenese žádnou odpovědnost, pokud se to někdy stane';
  ...
  String get choose_your_region_description =>
      'To pomůže Melora ukázat vám správný obsah\npro vaši lokalitu.';
  ...
  String get help_project_grow_description =>
      'Melora je open-source projekt. Můžete pomoci tomuto projektu růst tím, že přispějete do projektu, nahlásíte chyby nebo navrhnete nové funkce.';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Byla vydána noční verze Melora $nightlyBuildNum';
  }

  @override
  String release_version(Object version) {
    return 'Byla vydána verze Melora v$version';
  }
