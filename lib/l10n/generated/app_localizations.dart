...
abstract class AppLocalizations {
  ...
  /// No description provided for @u_love_Melora.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @about_Melora.
  ///
  /// In en, this message translates to:
  /// **'About Melora'**
  String get about_Melora;
  ...
  ///
  /// In en, this message translates to:
  /// **'Control Melora from other devices'**
  ...
  ///
  /// In en, this message translates to:
  /// **'Melora Nightly {nightlyBuildNum} has been released'**
  String nightly_version(Object nightlyBuildNum);

  /// No description provided for @release_version.
  ///
  /// In en, this message translates to:
  /// **'Melora v{version} has been released'**
