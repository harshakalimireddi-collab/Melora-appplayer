...
class AppLocalizationsCa extends AppLocalizations {
  ...
  @override
  String get u_love_Melora => 'Sabem que li encanta Melora';

  @override
  String get check_for_updates => 'Buscar actualitzacions';

  @override
  String get about_Melora => 'Sobre Melora';
  ...
  String get download_ip_ban_warning =>
      'Per cert, la seva IP pot ser bloquejada a YouTube degut a solicituds de descàrrega excessives. El bloqueig d\'IP vol dir que no podrà utilitzar YouTube (fins i tot si ha iniciat sessió) durant un mínim de 2-3 meses desde esa dirección IP. I Melora no es fa responsable si això succeeix en alguna ocasió';
  ...
  String get download_agreement_3 =>
      'Sóc completament conscient que la meva IP pot ser bloqueada per YouTube i no responsabilizo a Melora ni als seus propietaris/contribuents per qualsevol incident causat per la meva acció actual';
  ...
  String get encryption_failed_warning =>
      'Melora utilitza el xifrado per emmagatzemar les seves dades de forma segura. Però ha fallat. Per tant, tornarà a un emmagatzament no segur\nSi estè utilizant Linux, asseguri\'s de tenir instal·lats els serveis secrets com gnome-keyring, kde-wallet i keepassxc';
  ...
  String get choose_your_region_description =>
      'Això ajudarà a Melora a mostrar-vos el contingut adequat\nper a la vostra ubicació.';
  ...
  String get help_project_grow_description =>
      'Melora és un projecte de codi obert. Podeu ajudar a fer créixer aquest projecte contribuint al projecte, informant d\'errors o suggerint noves funcionalitats.';
  ...
  String get enable_connect_description =>
      'Controla Melora des d\'altres dispositius';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Melora Nightly $nightlyBuildNum ha estat publicat';
  }

  @override
  String release_version(Object version) {
    return 'Melora v$version ha estat publicat';
  }
