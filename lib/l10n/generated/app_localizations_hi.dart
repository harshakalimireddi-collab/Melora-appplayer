...
class AppLocalizationsHi extends AppLocalizations {
  ...
  @override
  String get u_love_Melora => 'हम जानते हैं कि आप Melora से प्यार करते हैं';

  @override
  String get check_for_updates => 'अपडेट के लिए जाँच करें';

  @override
  String get about_Melora => 'Melora के बारे में';
  ...
  String get spotube_description =>
      'Melora, एक हल्का, सभी प्लेटफॉर्मों पर चलने वाला, मुफ्त स्पॉटिफाई क्लाइंट';
  ...
  String get choose_your_region_description =>
      'यह Melora को आपके स्थान के लिए सही सामग्री दिखाने में मदद करेगा।';
  ...
  String get help_project_grow_description =>
      'Melora एक ओपन सोर्स परियोजना है। आप इस परियोजना को योगदान देकर, बग रिपोर्ट करके या नई विशेषताओं का सुझाव देकर इस परियोजना को बढ़ा सकते हैं।';
  ...
  String get enable_connect_description =>
      'अन्य उपकरणों से Melora को नियंत्रित करें';
  ...
  @override
  String get spotube_has_an_update => 'Melora में एक अपडेट है';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Melora Nightly $nightlyBuildNum जारी किया गया है';
  }

  @override
  String release_version(Object version) {
    return 'Melora v$version जारी किया गया है';
  }
