...
class AppLocalizationsFr extends AppLocalizations {
  ...
  @override
  String get u_love_Melora => 'Nous savons que vous aimez Melora';

  @override
  String get check_for_updates => 'Vérifier les mises à jour';

  @override
  String get about_Melora => 'À propos de Melora';
  ...
  String get spotube_description =>
      'Melora, un client Spotify léger, multiplateforme et gratuit pour tous';
  ...
  String get download_ip_ban_warning =>
      'Au fait, votre adresse IP peut être bloquée sur YouTube en raison d\'une demande excessive de téléchargements par rapport à la normale. Le blocage de l\'IP signifie que vous ne pourrez pas utiliser YouTube (même si vous êtes connecté) pendant au moins 2 à 3 mois à partir de cet appareil IP. Et Melora ne peut être tenu responsable si cela se produit.';
  ...
  String get download_agreement_3 =>
      'Je suis parfaitement conscient(e) que mon adresse IP peut être bloquée sur YouTube et je ne tiens pas Melora ni ses propriétaires/contributeurs responsables de tout accident causé par mon action actuelle.';
  ...
  String get encryption_failed_warning =>
      'Melora utilise le cryptage pour stocker vos données en toute sécurité. Mais cela a échoué. Il basculera donc vers un stockage non sécurisé\nSi vous utilisez Linux, assurez-vous d\'avoir installé des services secrets tels que gnome-keyring, kde-wallet et keepassxc';
  ...
  String get choose_your_region_description =>
      'Cela aidera Melora à vous montrer le bon contenu pour votre emplacement.';
  ...
  String get help_project_grow_description =>
      'Melora est un projet open-source. Vous pouvez aider ce projet à grandir en contribuant au projet, en signalant des bugs ou en suggérant de nouvelles fonctionnalités.';
  ...
  String get enable_connect_description =>
      'Contrôlez Melora depuis d\'autres appareils';
  ...
  @override
  String get spotube_has_an_update => 'Melora a une mise à jour';
  ...
  String nightly_version(Object nightlyBuildNum) {
    return 'Melora Nightly $nightlyBuildNum a été publié';
  }

  @override
  String release_version(Object version) {
    return 'Melora v$version a été publié';
  }
