...
import 'package:melora/hooks/utils/use_force_update.dart';
                    ...
                    Tooltip(
                      ...
                      child: IconButton(
                        ...
                        icon: showLyrics.value
                            ? const Icon(MeloraIcons.lyrics)
                            : const Icon(MeloraIcons.lyricsOff),
                        onPressed: () async {
                    ...
                    Tooltip(
                      ...
                      child: IconButton(
                        ...
                        icon: hoverMode.value
                            ? const Icon(MeloraIcons.hoverOn)
                            : const Icon(MeloraIcons.hoverOff),
                        onPressed: () async {
                          areaActive.value = true;
                ...
                children: [
                  ...
                  Tooltip(
                    tooltip: TooltipContainer(
                        ...
                        .call,
                    child: IconButton.ghost(
                      icon: const Icon(MeloraIcons.maximize),
                      onPressed: () async {
