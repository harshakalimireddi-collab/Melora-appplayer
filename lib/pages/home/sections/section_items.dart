...
import 'package:melora/components/waypoint.dart';
...
import 'package:melora/provider/metadata_plugin/browse/section_items.dart';
...
class HomeBrowseSectionItemsPage extends HookConsumerWidget {
  ...
  final MeloraBrowseSectionObject<Object> section;
              ...
              slivers: [
                SliverGrid.builder(
                  ...
                  itemBuilder: (context, index) {
                    ...
                    return switch (item) {
                      MeloraFullArtistObject() => ArtistCard(item),
                      MeloraSimplePlaylistObject() => PlaylistCard(item),
                      MeloraSimpleAlbumObject() => AlbumCard(item),
                      _ => throw Exception(
