...
import 'package:melora/components/track_presentation/presentation_actions.dart';
...
import 'package:melora/modules/library/local_folder/cache_export_dialog.dart';
import 'package:melora/pages/library/user_local_tracks/user_local_tracks.dart';
import 'package:melora/components/expandable_search/expandable_search.dart';
...
import 'package:melora/components/track_presentation/sort_tracks_dropdown.dart';
...
class LocalLibraryPage extends HookConsumerWidget {
  ...
  Future<void> playLocalTracks(
    WidgetRef ref,
    List<MeloraLocalTrackObject> tracks, {
    MeloraLocalTrackObject? currentTrack,
  }) async {
                  ...
                  children: [
                    ...
                    Tooltip(
                      ...
                      child: IconButton.outline(
                        ...
                        icon: const Icon(MeloraIcons.shuffle),
                      ),
                    ),
                    const Gap(5),
                    Tooltip(
                      ...
                      child: IconButton.outline(
                        onPressed: trackSnapshot.asData?.value != null
                            ...
                            : null,
                        enabled: !isPlaylistPlaying,
                        icon: const Icon(MeloraIcons.queueAdd),
                      ),
                    ),
                    const Spacer(),
                    ...
                    const Gap(5),
                    IconButton.outline(
                      icon: const Icon(MeloraIcons.refresh),
                      onPressed: () {
                        ref.invalidate(localTracksProvider);
                      },
                    )
                  ...
                  data: (tracks) {
                    final sortedTracks = useMemoized(() {
                      return ServiceUtils.sortTracks(
                          tracks[location] ?? <MeloraLocalTrackObject>[],
                          sortBy.value);
                    }, [sortBy.value, tracks]);
