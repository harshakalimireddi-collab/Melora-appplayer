...
import 'package:melora/components/form/text_form_field.dart';
import 'package:melora/components/titlebar/titlebar.dart';
import 'package:melora/extensions/context.dart';
import 'package:melora/models/metadata/metadata.dart';
import 'package:melora/modules/metadata_plugins/installed_plugin.dart';
import 'package:melora/modules/metadata_plugins/plugin_repository.dart';
import 'package:melora/provider/metadata_plugin/core/repositories.dart';
          ...
          return availablePlugins.where(
            (d) {
              return d.topics.contains(
                tabState.value == 1
                    ? "melora-metadata-plugin"
                    : "melora-audio-source-plugin",
              );
            },
          ).toList();
        }
                  ...
                  children: [
                    ...
                    Tooltip(
                      ...
                      child: IconButton.primary(
                        icon: const Icon(MeloraIcons.upload),
                        onPressed: () async {
                          Uint8List bytes;
                        ...
                        child: Column(
                          ...
                          children: [
                            Row(
                              spacing: 8,
                              children: [
                                const Icon(MeloraIcons.warning, size: 16),
                                Text(
