  ...
  Widget build(BuildContext context, ref) {
    ...
    final children = [
      AdaptiveSelectTile<LayoutMode>(
        secondary: const Icon(MeloraIcons.dashboard),
      ...
      AdaptiveSelectTile<ThemeMode>(
        secondary: const Icon(MeloraIcons.darkMode),
      ...
      // ListTile(
      //     leading: const Icon(MeloraIcons.amoled),
      ...
      //     )),
      ListTile(
        leading: const Icon(MeloraIcons.palette),
      ...
      // ListTile(
      //     leading: const Icon(MeloraIcons.colorSync),
