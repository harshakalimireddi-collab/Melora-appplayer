...
import 'package:melora/components/track_presentation/track_presentation.dart';
...
class PlaylistPage extends HookConsumerWidget {
  ...
  final MeloraSimplePlaylistObject _playlist;
  final String id;
  const PlaylistPage({
    super.key,
    @PathParam("id") required this.id,
    required MeloraSimplePlaylistObject playlist,
  }) : _playlist = playlist;
