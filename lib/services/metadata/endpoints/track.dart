...
class MetadataPluginTrackEndpoint {
  ...
  Future<MeloraFullTrackObject> getTrack(String id) async {
    final raw =
        await hetuMetadataTrack.invoke("getTrack", positionalArgs: [id]) as Map;

    return MeloraFullTrackObject.fromJson(
  ...
  Future<List<MeloraFullTrackObject>> radio(String id) async {
    ...
    return (result as List)
        .map(
          (e) => MeloraFullTrackObject.fromJson(
