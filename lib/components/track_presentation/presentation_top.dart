...
import 'package:melora/components/track_presentation/use_action_callbacks.dart';
import 'package:melora/components/track_presentation/use_is_user_playlist.dart';
    ...
    final playbackActions = Row(
      ...
      children: [
        Tooltip(
          ...
          child: IconButton.secondary(
            icon: isLoading
                ...
                : const Icon(MeloraIcons.shuffle),
        ...
        if (mediaQuery.width <= 320)
          ...
          Button.secondary(
            leading: const Icon(MeloraIcons.add),
            enabled: !isLoading && !isActive,
            onPressed: onAddToQueue,
