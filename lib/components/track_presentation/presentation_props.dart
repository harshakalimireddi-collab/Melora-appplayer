...
class PaginationProps {
  ...
  final Future<List<MeloraFullTrackObject>> Function() onFetchAll;
...
class TrackPresentationOptions {
  ...
  final List<MeloraFullTrackObject> tracks;
  ...
  const TrackPresentationOptions({
    ...
    this.onHeart,
    this.error,
  }) : assert(collection is MeloraSimpleAlbumObject ||
            collection is MeloraSimplePlaylistObject);

  String get collectionId => collection is MeloraSimpleAlbumObject
      ? (collection as MeloraSimpleAlbumObject).id
      : (collection as MeloraSimplePlaylistObject).id;
