...
import com.melora.app.MainActivity
import com.melora.app.glance.models.Track
import com.melora.app.glance.widgets.FlutterAssetImageProvider
import com.melora.app.glance.widgets.TrackDetailsView
import com.melora.app.glance.widgets.TrackProgress
...
abstract class InteractiveAction(val command: String) : ActionCallback {
    override suspend fun onAction(
        ...
        val backgroundIntent = HomeWidgetBackgroundIntent.getBroadcast(
            context,
            Uri.parse("melora://playback/$command?serverAddress=$serverAddress")
        )
